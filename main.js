...
electron_1.ipcMain.on('down', function (event, msg) {
    var inf = [];
    for (var asin in infos) {
        infos[asin].asin = asin;
        inf.push(infos[asin]);
    }
    var xls = json2xls(inf);
...
var get2 = function (url) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                _c.trys.push([1, 3, , 4]);
                return [4 /*yield*/, superagent.get(url + '&page=' + page)
                        // tslint:disable-next-line: max-line-length
                ...
                _loop_1 = function (i) {
                    ...
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            ...
                            case 1:
                                _c.sent();
                                return [4 /*yield*/, page.waitForSelector('.legendScale')];
                            case 2:
                                _c.sent();
                            ...
                            case 5:
                                res = _c.sent();
                                $_1 = cheerio.load(res.text);
                                a = $_1('#reviewsMedley > div > div.a-fixed-left-grid-col.a-col-left > div.a-section.a-spacing-none.a-spacing-top-mini.cr-widget-ACR > div > div > div.a-fixed-left-grid-col.a-col-right > div > span > span > a > span').text();
                                b = $_1('#histogramTable > tbody > tr > td:nth-child(3)').map(function (i, ele) { return $_1(ele).text(); }).get().join(' ');
                                infos[asins[i]].rate = a + " " + b;
                                console.log(asins[i]);
                                console.log(a + " " + b);
                                // 排名
                                infos[asins[i]].rank = $_1('body').text().match(/#\d*?,?\d* in .*/g) + "";
                                date = 'NONE';
                                if (/Date first /.test($_1('body').text())) {
                                    // tslint:disable-next-line: max-line-length
                                    date = $_1('body').text().match(reg1)[1];
                                }
